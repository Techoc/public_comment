...
CREATE TABLE `hotel` (
  ...
  `taste` float DEFAULT NULL COMMENT '口味',
  `env` float DEFAULT NULL,
  `service` float DEFAULT NULL,
  `addr` varchar(128) DEFAULT NULL,
  `short_type` varchar(64) DEFAULT NULL,
  `business_time` varchar(64) DEFAULT NULL,
  `map_addr` varchar(128) DEFAULT NULL,
  `map_addr2` varchar(128) DEFAULT NULL,
  `bang` varchar(128) DEFAULT NULL,
  PRIMARY KEY (`id`)
